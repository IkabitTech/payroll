...
<div class="container notprint">
  ...
  <span></span><a class="btn btn-default " href="<?= base_url() ?>/records/summary/<?= $payroll?>/<?= $companyindex?>" > SEND EMAIL TO ALL</a>
</div>
...
$i++;
 ...
 ?>
    ...
    <?php $mydata = $this->Main->all2('payroll_columns','payroll',$payroll,'company', $this->session->userdata('companyarray')[$companyindex]['id']);
      ...
      <td><?= $this->Main->mycolumn3('payrollrecords','value','payroll', $payroll,'employee', $a['employee'],'value_id', $value['id']) ?>
