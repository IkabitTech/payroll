...
<div class="container" >
 ...
 <?php if(($this->session->userdata('level') >= 1 && $this->session->userdata('level') <= 4) || $this->session->userdata('level') == 10 ){
...
elseif($this->session->userdata('level') == 10){$me = 'Human Resource Manager';}
