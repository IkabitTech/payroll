...
class Records extends CI_Controller {
 ...
 public function __construct(){
	...
	{  
		...
		$values['view'] = $this->load->view('hr/record_set', $data, TRUE);
...
$data['secretvalue']='summary';
		...
		$values['view'] = $this->load->view('hr/record', $data, TRUE);
...
$data['secretvalue']='summary';
		...
		$values['view'] = $this->load->view('hr/salaryslip', $data, TRUE);
	...
	{  
		...
		$values['view'] = $this->load->view('hr/mypayrollslip2', $data, TRUE);
