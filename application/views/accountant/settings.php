             ...
             <div class="col-md-6 col-sm-6  pricing-desc">
                ...
                <div class="col-md-6 col-sm-6 block" >
                    ...
                    <?php if($this->Main->isExist2('have_allowance','company', $this->session->userdata('companyarray')[$companyindex]['id'] ,'allowance', 1) ){ ?>
                     <li><i class="fa fa-check"></i><span> Have</span>
<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>
                      <a onclick="Allowance(0, 1)"><strong>remove</strong></a>

                      </li><?php }}else{ ?>
                      <li><i class="fa fa-times"></i><span> Dont have</span>
<?php if($this->session->userdata('level') == 3   || $this->session->userdata('level') == 1 ){ ?>
                       <a onclick="Allowance(1, 1)"><strong>add</strong></a
                     ...
                     <li class="alternate"><i class="fa fa-check"></i><span> Have</span>

                     <?php if($this->session->userdata('level') == 3   || $this->session->userdata('level') == 1 ){ ?>

                      <a onclick="Allowance(0, 2)"><strong>remove</strong></a></li><?php }}else{ ?>
                      <li class="alternate"><i class="fa fa-times"></i><span> Dont have</span>

<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>
                       <a onclick="Allowance(1, 2)"><strong>add</strong></a></li><?php }} ?>


                        <?php if($this->Main->isExist2('have_allowance','company', $this->session->userdata('companyarray')[$companyindex]['id'] ,'allowance', 3) ){ ?>
                     <li><i class="fa fa-check"></i><span> Have</span>
<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>
                      <a onclick="Allowance(0, 3  || $this->session->userdata('level') == 1 )"><strong>remove</strong></a></li><?php }}else{ ?>
                      <li><i class="fa fa-times"></i><span> Dont have</span> 
<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>
  <a onclick="Allowance(1, 3)"><strong>add</strong></a></li><?php }} ?>


                        <?php if($this->Main->isExist2('have_allowance','company', $this->session->userdata('companyarray')[$companyindex]['id'] ,'allowance', 4) ){ ?>
                     <li class="alternate"><i class="fa fa-check"></i><span> Have</span>
<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>
                      <a onclick="Allowance(0, 4)"><strong>remove</strong></a></li><?php }}else{ ?>
                      <li class="alternate"><i class="fa fa-times"></i><span> Dont have</span>
<?php if($this->session->userdata('level') == 3   || $this->session->userdata('level') == 1 ){ ?>
                       <a onclick="Allowance(1, 4)"><strong>add</strong></a></li><?php } } ?>


                        <?php if($this->Main->isExist2('have_allowance','company', $this->session->userdata('companyarray')[$companyindex]['id'] ,'allowance', 5) ){ ?>
                     <li><i class="fa fa-check"></i><span> Have</span>
<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>
                      <a onclick="Allowance(0, 5)"><strong>remove</strong></a></li><?php }}else{ ?>
                      <li><i class="fa fa-times"></i><span> Dont have</span> 
<?php if($this->session->userdata('level') == 3   || $this->session->userdata('level') == 1 ){ ?>
  <a onclick="Allowance(1, 5)"><strong>add</strong></a></li><?php } } ?>
...
<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>
                    <a onclick="NightOvertime(0)"><strong>remove</strong></a></li>
...
<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>
                    <a onclick="NightOvertime(1)"><strong>add</strong></a></li>
...
<div class="col-md-6 col-sm-6  block">
        ...
        <ul class="pricing-table list-unstyled">
               ...
               <?php if($this->Main->mycolumn1('bonus','provided','company', $this->session->userdata('companyarray')[$companyindex]['id'] ) == 1){ ?>
                   ...
                   <li><i class="fa fa-check"></i><span> provided</span>
<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>

                    <a onclick="Bonus()"><strong>remove</strong></a></li>

                  <?php }?>

                   <li class="alternate">
<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>
                    <a data-toggle="modal" href="#bonusname"><i class="fa fa-pencil"></i></a>
<?php } ?>


                    <span> <?= $this->Main->mycolumn1('bonus', 'name','company',$this->session->userdata('companyarray')[$companyindex]['id'] ) ?> </span></li>

                   <?php }else{ ?>


                   <li><i class="fa fa-times"></i><span> not provided</span>

<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>

                    <a onclick="Bonus()"><strong>add</strong></a></li>
  ...
  $percent1 = $bf['percent'] ;
   ...
   $percentr = $bf['employer_contribution'];
    ...
    <tr>
      ...
      <td><?= $amount1 ?></td>
      <td><?= $this->Main->mycolumn1('salartype','salary', 'id',$bf['cut_from'])?></td>
      <td><?= $percent1?></td>
      <td><?= $percente ?></td>
      <td><?= $percentr ?></td>
      <td><?= $bf['min_amount'] ?></td>
...
<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>
        ...
        <a href="#editBf<?= $bf['id'] ?>" onclick="$('#calcfrom<?= $bf['id'] ?>').val(<?=$bf['salarytype']?>)" data-toggle="modal">Edit</a>  <a href="#deleteBf<?= $bf['id'] ?>" data-toggle="modal">Delete</a>
                                                ...
                                                <div class="row percentclass<?= $bf['id'] ?> ">
                                                      <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                  ...
                                                                  <input type="number" step="0.01" onchange="$('#p<?= $bf['id'] ?>').val(parseFloat($('#ep<?= $bf['id'] ?>').val()) + parseFloat($('#rp<?= $bf['id'] ?>').val()))"  required value="<?= $bf['employee_contribution'] ?>" onchange="$('#p').val(parseFloat($('#ep<?= $bf['id'] ?>').val()) + parseFloat($('#rp<?= $bf['id'] ?>').val()))" placeholder="Ex 20.55 or 20 or 23.5" class="form-control" id='ep<?= $bf['id'] ?>'>
                                                            </div>
...
<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>
        <a onclick="statusdeduction(0,<?= $bf2['id'] ?>, <?= $bf['name'] ?>, <?= $this->session->userdata('companyarray')[$companyindex]['id'] ?>)"><strong>remove</strong></a>
<?php }else{echo 'Yes';} ?>
...
<?php if($this->session->userdata('level') == 3  || $this->session->userdata('level') == 1 ){ ?>
        ...
        <a onclick="statusdeduction(1,<?= $bf2['id'] ?>, <?= $bf['name'] ?> ,<?= $this->session->userdata('companyarray')[$companyindex]['id'] ?>)"><strong>add</strong></a></td>
<?php }else{echo 'No';} ?>
                      ...
                      <input type="number" step="0.01"  required value="" placeholder="Ex 20.55 or 20 or 23.5" class="form-control" id='amount'>
								...
								<div class="row percentclass">
									<div class="form-group">
										...
										<div class="col-md-3">
											<label>Employee Percent</label>
											<input type="number" step="0.01" onchange="$('#p').val(parseFloat($('#ep').val()) + parseFloat($('#rp').val()))" required value="" placeholder="Ex 20.55 or 20 or 23.5" class="form-control" id='ep'>
										</div>
									
										<div class="col-md-3">
											<label>Employer Percent</label>
											<input type="number" step="0.01" onchange="$('#p').val(parseFloat($('#ep').val()) + parseFloat($('#rp').val()))"  required value="" placeholder="Ex 20.55 or 20 or 23.5" class="form-control" id='rp'>
										</div>
...
<input type="number" step=".0001"  class="form-control"  id="numdays" max="31" min="0"  value="<?= $this->Main->mycolumn1('average_monthdays', 'no_days','company_id',$this->session->userdata('companyarray')[$companyindex]['id'] ) ?>" placeholder="Number of Days">
</form></div>
