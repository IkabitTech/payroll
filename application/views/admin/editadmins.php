<header id="page-title"> <!-- style="background-image:url('assets/images/demo/parallax_bg.jpg')" -->
        ...
        -->
        <?php $ID = isset($_GET['user'])?$_GET['user']:0;  ?>
            ...
            <form method="post">
                ...
                <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text"   required value="<?= $this->Main->mycolumn1('admins','full_name','id',$ID) ?>" placeholder="Write Full Name" class="form-control cinput" id='name'>
                      <input type="text" required value="<?= $ID ?>"  class="form-control hidden" id='id'>
                     ...
                     <div class="col-md-6">
                      ...
                      <input type="text"   required value="<?= $this->Main->mycolumn1('admins','username','id',$ID) ?>" placeholder="Suggest Username But must be unique" class="form-control cinput" id='username' onchange="username2check()">
                ...
                <div class="row">
                  <div class="form-group">
                      ...
                      <input type="text"   required value="<?= $this->Main->mycolumn1('admins','phone','id',$ID) ?>" placeholder="Phone Number Must be unique" class="form-control cinput" id='phone'>
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text"  required value="<?= $this->Main->mycolumn1('admins','email_address','id',$ID) ?>" class="form-control cinput" id='email'>
                ...
                <div class="row">
                  <div class="form-group">
                      ...
                      <select type="text"  required value="" class="form-control cinput" id='status'>
                        ...
                        <option <?php if($this->Main->mycolumn1('admins','level','id',$ID) == 3){echo 'selected';} ?> value="3">Main Accountant</option>
                        <option <?php if($this->Main->mycolumn1('admins','level','id',$ID) == 4){echo 'selected';} ?> value="4">Accountant for Branches</option>
                        <option <?php if($this->Main->mycolumn1('admins','level','id',$ID) == 2){echo 'selected';} ?> value="2">Company Managers</option>
                        <option <?php if($this->Main->mycolumn1('admins','level','id',$ID) == 1){echo 'selected';} ?> value="1">Super Admin</option>
                      </select>
                      ...
                      <select type="text"  required value="" class="form-control cinput" id='status2'>
                        
                        <option <?php if($this->Main->mycolumn1('admins','active','id',$ID) == 1){echo 'selected';} ?> value="1">Active</option>
                        <option <?php if($this->Main->mycolumn1('admins','active','id',$ID) == 0){echo 'selected';} ?> value="0">Not Active</option>
                  
                      </select>
                      <p id="errorstatus2" style="color:red"></p>
                ...
                <div class="row">
                  <div class="form-group col-md-12">
                    ...
                    <input  readonly value="submit" onclick="EditNewAdmin()" class="form-control btn btn-primary">
                </div>
              </div>
