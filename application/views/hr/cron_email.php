...
body{
margin:0; margin-top:30px; margin-bottom:30px; padding:0; width:100%; -webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; background-color: white;}
...
$basic_salary= '';
               ...
               if(!empty($payrollrecords)){ foreach( $payrollrecords as $p){ 
                    ...
                    if($this->Main->mycolumn1('payroll_columns', 'name_excel','id',$p->value_id) == 'bonus'){ $bonus = (float)str_replace(array(',',' '), '', $p->value );}
...
<p style="margin:0 0 5px; color:red;font-size:12px"><strong>NOTE: Email is automatic cannot reply back, incase of any quires contact HR department</strong></p>
...
<div class="col-md-12">
  ...
  <p style="margin:0 0 0px"><?=$this->Main->mycolumn1('clients','contact_email', 'id', $co) ;?></p>
  <p style="margin:0 0 0px">Employee : <?=$allnames;?></p>
 <?php if($attendance !=''){ ?>
...
<div class="col-md-12">
<table cellpadding="0" cellspacing="0" border="0" width="100%" style="border:0; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; background-color: #F4F5F7;margin-top:20px">
...
<tr>
  ...
  <td><b><?= number_format(($sumearn - $sumdeduct - $bonus),2) ?></b></td>
  
  <?php $word=($sumearn - $sumdeduct - $bonus ); ?>
</tr>
...
<div class="col-md-12" style="margin-top: 30px">
  <p style="margin:0 0 5px; text-decoration: underline ;color:#39AADB;font-size:12px"><?php if($word >0){ ?> <strong>  <?php echo $this->Main->convertNumberToWord($sumearn - $sumdeduct - $bonus);  ?> TZS. Only </strong><?php }else{?> (-) Negative TZS <?php } ?></p>
  </div>
</div>
