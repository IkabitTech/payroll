<header id="page-title" class="notprint"><meta http-equiv="Content-Type" content="text/html; charset=utf-8"> <!-- style="background-image:url('assets/images/demo/parallax_bg.jpg')" -->
        <!--
...
<?php if($this->Main->mycolumn1('clients','contact_email', 'id', $co) !=''){ ?>
...
<div class="col-md-12">
  ...
  <table class="table-bordered table " style="background: transparent; margin-top:20px">
    <thead>
      <th>Earnings</th>
      <th></th>
      <th>Deductions</th>
