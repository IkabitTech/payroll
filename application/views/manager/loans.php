...
<table class="table table-striped table-dark"    
 >
  ...
  foreach( $bfsll AS  $bfll){ 
    ...
    $names =  $this->Main->mycolumn1('employees','first_name', 'id',$bfll->employee); 
...
<a class="btn btn-default " onclick="$('#myloan<?= $bfll->id ?>').modal('hide');$('#editloan<?= $bfll->id ?>').modal('show'); openeditloanform(<?= $bfll->id ?>,<?= $bfll->pay_style ?>,<?= $bfll->loantype ?>,'<?= $bfll->paymentmethod ?>',<?= $bfll->period_months?>, <?= $bfll->percent_basic ?>, <?= $bfll->amount_per_month_to_return ?>)">Edit Loan</a>
...
<?php if($this->session->userdata('level') == 2){ ?>
 ...
 <a class="btn btn-danger " onclick="" >MAKE INACTIVE</a>
 <a class="btn btn-default " onclick="">MAKE ACTIVE</a>

<?php } ?>

<?php if($this->session->userdata('level') == 3){ ?>

  <a class="btn btn-success " onclick="">SUSPEND LOAN</a>
 <a class="btn btn-warning " onclick="">REMOVE LOAN</a>]


   <a class="btn btn-default " onclick="">FINISHED</a>
             ...
             <div class="col-md-6">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <input  readonly value="SUBMIT INFORMATIONS" onclick="EditLoan()" class="form-control btn btn-primary">
                </div>
              </div>
