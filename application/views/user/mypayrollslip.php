...
<?php
   ...
   $user = $this->session->userdata('userid');
    ...
    $co_name = $this->session->userdata('companyarray')['company_name'];
...
<div class= "col-md-12 table-responsive" id='mytablelist'>
   ...
   <?php if($this->Main->isExist3('payrollrecords', 'company',$this->session->userdata('companyarray')['company_id'],'payroll',$payroll,'employee', $user)){
 ...
 if($this->Main->isExist3('payroll_records_bonus', 'company',$co,'payroll',$payroll,'employee',$user)){
               ...
               if($this->Main->isExist3('payroll_records_employer_deductions', 'company',$co,'payroll',$payroll,'employee',$user)){
                ...
                $deductname[$deduct] = 'Employee Deduct : '.$this->Main->mycolumn3('payroll_records_employer_deductions','amount', 'payroll',$payroll,'employee',$user,'company', $co) ;
...
<div class="container">
  ...
  <p class="lead text-left col-md-3" style="padding-top: 10px"><span style=""><img src="<?= base_url() ?>assets/images/company_logo/<?= $this->session->userdata('companyarray')['logo'] ?>"  onerror="this.onerror=null;this.src='<?= base_url() ?>assets/images/logo.png';" style="height:50px"/></span>
