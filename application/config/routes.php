...
$route['records/(:num)'] = 'records/index/$1';
...
$route['company/add-admin/(:num)'] = 'company/add_admin/$1';
$route['company/edit-admin/(:num)'] = 'company/edit_admin/$1';
$route['cron/cron_email'] = "cron/cron_email";
